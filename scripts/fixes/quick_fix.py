...
class QuickFixer:
    ...
    def fix_current_turn_issue(self):
        """修复current_turn vs current_turn问题"""
        print("\n🔧 修复current_turn问题...")
        ...
        for file_pattern in files_to_fix:
            for file_path in self.project_root.glob(file_pattern):
                if self.fix_in_file(file_path, pattern, replacement):
                    self.fixes_applied.append(f"修复current_turn: {file_path.relative_to(self.project_root)}")
                    
    def fix_rules_access_issue(self):
        """修复rules访问问题"""
        print("\n🔧 修复rules访问问题...")
        
        # 修复 self.game_mgr.rules
        ...
        replacement3 = 'list(list(self.game_mgr.state.locations.keys()).keys())'
    ...
    def fix_pydantic_v2_syntax(self):
        ...
        replacements = [
            ...
            (r'@field_validator\b', '@field_validator'),
            (r'model_config = ConfigDict(', 'model_config = ConfigDict('),
            (r'json_schema_extra', 'json_json_schema_extra'),
    ...
    def fix_import_paths(self):
        ...
        wrong_imports = [
            ...
            ('from src.api.deepseek_client', 'from src.api.deepseek_client'),
            ('from src.core.game_state', 'from src.core.game_state'),
        ]
